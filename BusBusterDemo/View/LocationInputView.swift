...
//        tf.placeholder = "Current Location"
        tf.placeholder = "Введите номер экскурсионного билета.."
        tf.backgroundColor = UIColor.rgb(red: 215, green: 215, blue: 215)
        tf.returnKeyType = .search
        tf.font = UIFont.systemFont(ofSize: 14)
        let paddingView = UIView()
        paddingView.setDimensions(height: 10, width: 8)
...
//                                    paddingRight: 40,height: 30)
        ...
        destinationIndicatorView.centerY(inView: startLocationIndicatorView, leftAnchor: leftAnchor, paddingLeft: 20)
