...
extension ContainerController: MenuControllerDelegate {
    func didSelect(option: MenuOptions) {
        ...
        animateMenu(shouldExpand: isExpanded) { _ in
			...
			case .stop:
				let alert = UIAlertController(title: nil,
                                              message: "Объявить остановку",
                                              preferredStyle: .actionSheet)

                alert.addAction(UIAlertAction(title: "20 минут", style: .destructive, handler: { _ in
					sendNotificationsStop20()
                }))

                alert.addAction(UIAlertAction(title: "40 минут", style: .destructive, handler:{ _ in
					sendNotificationsStop40()
                }))
            ...
            case .cancelTrip:
                let alert = UIAlertController(title: nil,
                                              message: "Точно отменить экскурсию?",
                                              preferredStyle: .actionSheet)

                alert.addAction(UIAlertAction(title: "Да", style: .destructive, handler: { _ in
					sendNotificationsCancel()
                }))
